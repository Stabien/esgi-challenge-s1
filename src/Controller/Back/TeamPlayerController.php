...
{
    #[Route('/', name: 'app_back_team_player_index', methods: ['GET'])]
    public function index(TeamPlayerRepository $teamPlayerRepository): Response
    {
        return $this->render('back/team_player/index.html.twig', [
            'team_players' => $teamPlayerRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_back_team_player_new', methods: ['GET', 'POST'])]
    public function new(Request $request, TeamPlayerRepository $teamPlayerRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_back_team_player_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('back/team_player/new.html.twig', [
            'team_player' => $teamPlayer,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_back_team_player_show', methods: ['GET'])]
    public function show(TeamPlayer $teamPlayer): Response
    {
        return $this->render('back/team_player/show.html.twig', [
            'team_player' => $teamPlayer,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_back_team_player_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, TeamPlayer $teamPlayer, TeamPlayerRepository $teamPlayerRepository): Response
    {
        ...
        return $this->renderForm('back/team_player/edit.html.twig', [
            'team_player' => $teamPlayer,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_back_team_player_delete', methods: ['POST'])]
